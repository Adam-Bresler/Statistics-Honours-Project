...
# get classification rate based on confusion matrix
...
# plot raw feature set ROC curves
...
# plot engineered feature set ROC curves
...
# raw weighted is best feature set, do model building
