...
colnames(data)[226] <- paste("rolling_average", colnames(data)[226], sep="_")
data <- rolling_average_by_court(data, 226, 24)
colnames(data)[226] <- paste("rolling_average_by_court", colnames(data)[226], sep="_")
data <- weighted_rolling_average(data, 226)
colnames(data)[226] <- paste("weighted_rolling_average", colnames(data)[226], sep="_")
data <- weighted_rolling_average_by_court(data, 226)
colnames(data)[226] <- paste("weighted_by_court", colnames(data)[226], sep="_")
